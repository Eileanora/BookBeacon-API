...
public static class DependencyInjection
{
    public static void AddApiServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IPaginationHelper<CopyDto, CopyResourceParameters>, PaginationHelper<CopyDto, CopyResourceParameters>>();
        ...
        services.AddScoped<ICopyControllerFacade, CopyControllerFacade>();
